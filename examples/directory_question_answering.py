...
from pydoxtools.extract_nlpchat import OpenAIChat
...
if __name__ == "__main__":
    ...
    if need_index:
        ...
        #with ProgressBar():
        #    idx.idx_dict.count().compute()  # remove number to calculate for all files!
        ...
        query("How to contribute to this library?")
