...
pdf_file = Path("../../tests/data/PFR-PR23_BAT-110__V1.00_.pdf")
...
pdf = Document(pdf_file, spacy_model_size="md", coreference_method="fast")
doc = pdf
...
entities=["document"]
relations=[]
for p in doc.page_set:
    relations+=[["document","has","page[{}]"]]
